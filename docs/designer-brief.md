...
First-person prompt to hand to a professional UI/UX designer. Companion to [design-brief.md](./design-brief.md) (which is the internal token/constraint reference). This one is pasteable into an email, RFP, or scope-of-work.
...
**What the app does.** I own a fragrance collection and remember nothing. The app is a searchable catalog of the bottles I actually own — brand, name, concentration (EDT / EDP / Parfum / Cologne / Other), a freeform list of accords, a 0–10 rating. Four screens today: sign-in, collection list, add form, detail (with edit + delete). Next phase adds a wear calendar. Eventually barcode scanning and a shared fragrance DB. I'm not trying to compete with Fragrantica or Parfumo — those are review communities with spreadsheet aesthetics. This is a private companion that lives on one person's phone.
...
5. **The wear calendar screen** — entirely unbuilt, Phase 1.5. Month grid vs. week ribbon vs. fragrance-centric "last worn" view — I don't know which is right. This is where I most need your judgment.
...
**Scope for the first deliverable.** A Figma file with four frame groups:
